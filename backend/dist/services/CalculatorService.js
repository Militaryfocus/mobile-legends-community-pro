...
class CalculatorService {
    ...
    async compareBuilds(build1, build2) {
    ...
    async getOptimalBuild(heroId, playstyle, budget) {
    ...
    calculateEmblemStats(emblems) {
        ...
        emblems.forEach(emblem => {
            const emblemStats = emblem.stats;
            if (emblemStats) {
    ...
    generateRecommendations(stats, synergies, hero) {
    ...
    compareResults(result1, result2) {
        ...
        const keyStats = ['physicalAttack', 'magicPower', 'hp', 'armor', 'magicResistance'];
